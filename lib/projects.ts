...
export const ALL_PROJECTS: ProjectData[] = [
  ...
  },
  {
    ...
    description: 'Automated PR pipeline that scans Google Alerts every morning, runs each mention through Groq AI for sentiment analysis and draft replies, queues Gmail drafts for journalist follow-ups, logs everything to Notion, and sends the team a Telegram briefing.',
    stack:       ['Make.com', 'Groq API', 'Google Alerts RSS', 'Gmail', 'Notion', 'Telegram Bot'],
    ...
    pills:       ['MAKE.COM', 'GROQ API', 'NOTION'],
    pattern:     'pipeline',
    ...
    pipeline: [
      ...
      { num: '03', integration: 'MAKE.COM -> GROQ API',          title: 'AI Analysis',              desc: "Groq AI reads each mention. Outputs sentiment, 2-sentence summary, and draft reply in founder's voice." },
